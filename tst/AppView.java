...
public class AppView extends View {
	...
	private TabPanel getCenterWidget() {
		...
		if (centerPanel == null) {
			...
			TabItem userDetails = new TabItem("UserDetails");
			TabItem softwareDetails = new TabItem("SoftwareDetails");
			TabItem policyDetails = new TabItem("PolicyDetails");
		...
		if (logoutButton == null) {
			...
			logoutButton.addSelectionListener(new SelectionListener<ButtonEvent>() {
				...
				public void componentSelected(ButtonEvent ce) {
					MessageBox.confirm("Confirm", "Are you sure to logout?", new Listener<MessageBoxEvent>() {
						@Override
	...
	protected void handleEvent(AppEvent event) {
		...
		if (type.getEventCode() == AppEvents.LoginSuccess.getEventCode()) {
			initUI();
		} else if (type.getEventCode() == AppEvents.search.getEventCode()) {
